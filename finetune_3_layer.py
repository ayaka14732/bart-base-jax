...
params_ch = jax.tree_map(np.asarray, load_params('ch_trained_emb_3_layers.dat'))
...
def save_ckpt():
    ...
    save_params(params, 'bart_stage1_3_random_layer_ckpt.dat')
...
for _ in tqdm_epoch:
    ...
    tqdm_batch = trange(stop_step, desc='Batch', leave=False)
